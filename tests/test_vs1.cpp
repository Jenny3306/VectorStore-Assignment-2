...
TEST_CASE("test_205")
{
    ...
    CHECK(printVectorRecord(store.getRootVector()) == "ID=3, RawText=2, RawLength=1, Vector=[2.00], Distance=2.00, Norm=2.00");
    ...
    store.addText("3");
    CHECK(printVectorRecord(store.getRootVector()) == "ID=5, RawText=3, RawLength=1, Vector=[3.00], Distance=3.00, Norm=3.00");
